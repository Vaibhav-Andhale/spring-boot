package com.vaibhav.project.configuration;

import com.vaibhav.project.dto.user.UserDetailsDTO;
import com.vaibhav.project.service.jwt.JWTService;
...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetailsDTO userDetailsDTO=userDetailsService.findByIdDTO(username);
            UserDetails userDetails= User
                    .withUsername(userDetailsDTO.getLoginID())
                    .password(new BCryptPasswordEncoder().encode(userDetailsDTO.getPassword()))
                    .roles("ADMIN")
                    .build();
